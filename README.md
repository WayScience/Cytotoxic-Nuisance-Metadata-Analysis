...
All results generated by the notebooks are saved in the `./results` directory. This directory is organized with subfolders that are numbered according to the module from which the results were produced.
