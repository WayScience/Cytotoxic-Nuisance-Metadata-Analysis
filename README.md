...
- **JUMP-Aligned Feature-Selected Cell Injury Profiles:** These profiles were created by applying feature selection to the cell injury profiles were the feature space is aligned with the JUMP data.
