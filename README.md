...
- **Feature-Selected Cell Injury Profiles:** These profiles were generated by applying feature selection exclusively to the cell injury dataset, without any alignment to the JUMP data.
